        ...
        if (Schema::hasTable('ventas')) {
            Schema::table('ventas', function (Blueprint $table) {
                if (!Schema::hasColumn('ventas', 'origen_usuario_id')) {
                    $table->string('origen_usuario_id')->nullable()->after('origen_sistema');
                }
                if (!Schema::hasColumn('ventas', 'origen_usuario_nombre')) {
                    $table->string('origen_usuario_nombre')->nullable()->after('origen_usuario_id');
                }

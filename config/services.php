    ...
    */
    ...
    'ses' => [
     ...
     'agetic' => [
        ...
        'public_base_url' => env('AGETIC_PUBLIC_BASE_URL', 'https://sefe.agetic.gob.bo'),
    ...
    'qhantuy_checkout' => [
        ...
        'connect_timeout' => env('QHANTUY_CHECKOUT_CONNECT_TIMEOUT', 20),
        'timeout' => env('QHANTUY_CHECKOUT_TIMEOUT', 60),
